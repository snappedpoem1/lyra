...
llm_ready=True llm_error=
llm_model_boot_ok=True llm_model_boot_detail=already loaded: qwen2.5-14b-instruct
```
- [OK] **doctor**
...
[OK] Python: Python 3.12
  ...
  [OK] LM Studio (LLM): Live � model: qwen2.5-14b-instruct

Doctor result: ALL PASS
```
- [OK] **validate**
