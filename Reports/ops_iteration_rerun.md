...
llm_ready=False llm_error=daemon_up_ok=False detail=Command '['C:\\Users\\Admin\\AppData\\Local\\Programs\\LM Studio\\resources\\app\\.webpack\\lms.exe', 'daemon', 'up']' timed out after 8 seconds | server_start_ok=False detail=Command '['C:\\Users\\Admin\\AppData\\Local\\Programs\\LM Studio\\resources\\app\\.webpack\\lms.exe', 'server', 'start', '--port', '1234', '--bind', '127.0.0.1']' timed out after 8 seconds | model_load_deferred=model_server_not_ready model=qwen2.5-14b-instruct; LM Studio did not become ready before timeout
