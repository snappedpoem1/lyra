...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let with_files: i64 = conn.query_row("SELECT COUNT(*) FROM tracks WHERE filepath IS NOT NULL", [], |r| r.get(0))?;
    let unique_artists: i64 = conn.query_row("SELECT COUNT(DISTINCT artist) FROM tracks", [], |r| r.get(0))?;
    let unique_albums: i64 = conn.query_row("SELECT COUNT(DISTINCT album) FROM tracks", [], |r| r.get(0))?;
    ...
    let files: Vec<String> = stmt.query_map([], |r| r.get(0))?.collect::<Result<Vec<_>, _>>()?;
    ...
    println!("\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
    println!("  ✅ PROOF COMPLETE - {}/{} verified files exist", exists_count, files.len());
